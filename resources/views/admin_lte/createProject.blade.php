...
@section('content')
    ...
    <form id="CreateEventForm" action="{{route('CreateProjectSave')}}" enctype="multipart/form-data" method="post" onsubmit="CopyText();">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" placeholder="Elev, grupa" class="form-control" name="student">
                            </div>
                        </div>
                    </div>
                </div>
